...
define(function (require) {
    ...
    angular.module('home.controllers', ['filters', 'utils', 'auth.models', 'common.cache', 'notice.services'])
        .controller('HomeCtrl', ['$scope', '$location', '$log', 'currentUser', 'userCache', 'categoryCache', 'NoticeListService', 'dateUtil',
            function ($scope, $location, $log, currentUser, userCache, categoryCache, NoticeListService, dateUtil) {
